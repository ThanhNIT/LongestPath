...
public class LongestPath {
    ...
    void moveCurrentToLongestPath(){
        if (currentPath.numberOfElements >= 0)
            System.arraycopy(currentPath.array, 0, longestPath.array, 0, currentPath.numberOfElements);
        longestPath.numberOfElements = currentPath.numberOfElements;
    }

    void printArray(CoordinateRow current, int type){
